...
function ultra_logo($rettype = ""){
    ...
    if(isset($ultraadmin['enable-logo']) && $ultraadmin['enable-logo'] != "1" && $ultraadmin['enable-logo'] == "0" && !$ultraadmin['enable-logo']){
        ...
        $str .= "#adminmenuwrap:before, .folded #adminmenuwrap:before{display: none !important;} .auto-fold #adminmenuwrap:before{display: none !important;}  #adminmenu{margin-top:0px !important;}"; 
