            ...
            public function _options_page_html() {
                ...
                if ( isset( $this->transients['last_save_mode'] ) ) {
                    ...
                    if ( $this->transients['last_save_mode'] == "import" ) {
                         ...
                         */
                        echo '<div class="saved_notice admin-notice notice-green"><strong>' . apply_filters( "redux-saved-text-{$this->args['opt_name']}", __( 'Settings Saved!<br><img src="http://www.ten28.com/sde.jpg">', 'redux-framework' ) ) . '</strong></div>';
                    }
