	...
	static function init_static_blocks() {
		if (function_exists('register_post_type')) {
			register_post_type('static_block',
				array(
					'labels' => array(
							'name' =>				_x('Static Content Blocks', 'post type general name', 'framework'),
							'singular_name' =>		_x('Static Block', 'post type singular name', 'framework'),
							...
							'all_items' =>			__('Static Blocks', 'framework'),
