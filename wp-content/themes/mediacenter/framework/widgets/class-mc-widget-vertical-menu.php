...
class MC_Widget_Vertical_Menu extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo do_shortcode( '[mc_vertical_menu title="' . $instance['title']. '" icon_class="' . $instance['icon_class']. '" menu="' . $instance['menu']. '" dropdown_trigger="'. $instance['dropdown_trigger']. '" dropdown_animation="' . $instance['dropdown_animation']. '" el_class="'. $instance['el_class']. '"]' );
