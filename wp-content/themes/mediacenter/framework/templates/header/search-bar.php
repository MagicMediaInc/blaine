...
<div class="search-area animate-dropdown">
    <form role="search" id="search-header-form" method="get" action="<?php echo esc_url( home_url( '/'  ) ); ?>">
        <div class="search-control-group control-group">
            ...
            <input type="text" class="search-field" value="<?php echo get_search_query();?>" name="s" placeholder="<?php echo __( 'Search for products', 'woocommerce' );?>" />
            <div class="search-bar-controls">
                ...
                <?php endif; ?>
                <button type="submit" class="btn search-button" value="<?php echo esc_attr__( 'Search', 'woocommerce' );?>"></button>
