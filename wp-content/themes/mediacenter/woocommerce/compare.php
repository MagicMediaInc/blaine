...
<div class="container">
    ...
    <div class="section section-page-title inner-xs">
        <div class="page-header">
            ...
            <p class="page-subtitle"><a id="product-comparison-page-clear-all" href="<?php echo $yith_woocompare->obj->remove_product_url('all') ?>" data-product_id="all" class="clear-all"><?php _e( 'Clear all', 'yit' ) ?></a></p>
        </div>
