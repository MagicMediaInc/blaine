	...
	<div class="row">
		...
		<div class="<?php echo $loginSectionClass;?>">
			<section class="section sign-in inner-right-xs">
				<h2 class="bordered"><?php _e( 'Login', 'woocommerce' ); ?></h2>
				...
				<form method="post" class="login login-form cf-style-1" role="form">
					...
					<div class="field-row clearfix">
                    	<span class="pull-left">
                    		<label for="rememberme" class="inline content-color">
								<input name="rememberme" class="le-checbox auto-width inline" type="checkbox" id="rememberme" value="forever" /> <span class="bold"><?php _e( 'Remember me', 'woocommerce' ); ?></span>
							</label>
                    	</span>
                    	<span class="pull-right">
                    		<a class="content-color bold" href="<?php echo esc_url( wc_lostpassword_url() ); ?>"><?php _e( 'Lost your password?', 'woocommerce' ); ?></a>
                    	</span>
                    </div>
					...
					<div class="buttons-holder">
						...
						<input type="submit" class="le-button huge button" name="login" value="<?php _e( 'Login', 'woocommerce' ); ?>" /> 
					</div>
		...
		<div class="<?php echo $registerSectionClass;?>">
			...
			<section class="section register inner-left-xs">
				...
				<h2 class="bordered"><?php _e( 'Register', 'woocommerce' ); ?></h2>
				...
				<form method="post" class="register cf-style-1" role="form">
					...
					<div class="buttons-holder form-row">
						...
						<input type="submit" class="le-button huge button" name="register" value="<?php _e( 'Register', 'woocommerce' ); ?>" />
					</div>
			...
			<section class="inner-left-xs section why-register inner-top-xs">
				...
				<ul class="list-unstyled list-benefits">
					<li><i class="fa fa-check primary-color"></i> <?php echo __( 'Speed your way through the checkout', 'media_center' ); ?></li>
					<li><i class="fa fa-check primary-color"></i> <?php echo __( 'Track your orders easily', 'media_center' ); ?></li>
					<li><i class="fa fa-check primary-color"></i> <?php echo __( 'Keep a record of all your purchases', 'media_center' ); ?></li>
				</ul>
