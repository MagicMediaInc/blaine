        ...
        <div class="section lost-reset-password m-t-0">
            ...
            <form method="post" class="lost_reset_password">
                ...
                <div class="form-row buttons-holder">
                    <input type="submit" class="le-button button" name="wc_reset_password" value="<?php echo 'lost_password' == $args['form'] ? __( 'Reset Password', 'woocommerce' ) : __( 'Save', 'woocommerce' ); ?>" />
                </div>
