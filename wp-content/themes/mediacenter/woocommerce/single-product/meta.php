...
<div class="inline">
    <label class="sku_wrapper"><?php _e( 'SKU:', 'woocommerce' ); ?></label>
...
<?php if( $cat_count > 1 ): ?>
<div class="inline">
    <?php echo $product->get_categories( ', ', '<label class="posted_in">' . _n( 'Category:', 'Categories:', $cat_count, 'woocommerce' ) . '</label>&nbsp;<span>', '</span>' ); ?>
</div><!-- /.inline -->
    <?php if( $tag_count > 1 ): ?>
<span class="seperator">/</span>
    <?php endif; ?>
...
<div class="inline">
    <?php echo $product->get_tags( ', ', '<label class="tagged_as">' . _n( 'Tag:', 'Tags:', $tag_count, 'woocommerce' ) . '</label> <span>', '</span>' ); ?>
</div><!-- /.inline -->
<?php endif; ?>
