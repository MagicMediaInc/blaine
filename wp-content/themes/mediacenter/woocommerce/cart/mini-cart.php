...
<ul class="dropdown-menu cart_list product_list_widget <?php echo $args['list_class']; ?>">
	...
	<?php else : ?>
		...
		<li class="empty">
			<div class="basket-item">
				<p class="alert alert-warning"><?php _e( 'No products in the cart.', 'woocommerce' ); ?></p>
			</div>
		</li>
        ...
        <div class="basket-item">
            <div class="row">
                <div class="col-xs-6 col-sm-6">
                    <a class="le-button inverse" href="<?php echo WC()->cart->get_cart_url(); ?>"><?php _e( 'View Cart', 'woocommerce' ); ?></a>
                </div>
                <div class="col-xs-6 col-sm-6">
                    <a class="le-button" href="<?php echo WC()->cart->get_checkout_url(); ?>"><?php _e( 'Checkout', 'woocommerce' ); ?></a>
                </div>
            </div>
        </div>
    </li>
