			...
			<form action="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" method="post" class="track_order">
				...
				<div class="field-row row form-row form-row-first">
					<div class="col-xs-12">
						...
						<input class="le-input input-text" type="text" name="orderid" id="orderid" placeholder="<?php _e( 'Found in your order confirmation email.', 'woocommerce' ); ?>" />
					</div>
				</div>
				...
				<div class="field-row row form-row form-row-last">
					<div class="col-xs-12">
						...
						<input class="le-input input-text" type="text" name="order_email" id="order_email" placeholder="<?php _e( 'Email you used during checkout.', 'woocommerce' ); ?>" />
					</div>
				</div>

				<div class="form-row buttons-holder">
					<input type="submit" class="le-button huge button" name="track" value="<?php _e( 'Track', 'woocommerce' ); ?>" />
				</div>
